        ...
        <div className="fixed inset-0 z-[9999]">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-4 pointer-events-none">
            <motion.div
              ...
              className="w-full max-w-2xl max-h-[85vh] sm:max-h-[80vh] bg-white dark:bg-surface-900 rounded-2xl shadow-2xl overflow-hidden flex flex-col pointer-events-auto"
            >
              {/* Header */}
