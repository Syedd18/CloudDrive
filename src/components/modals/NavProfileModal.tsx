        ...
        <div className="fixed inset-0 z-[9999]">
          ...
          <div className="absolute inset-0 flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              ...
              <div className="relative bg-slate-50 dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 pt-5 pb-10 px-5">
                <button
                  onClick={onClose}
                  className="absolute top-3.5 right-3.5 p-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-500 hover:text-slate-700 dark:text-slate-400 rounded-lg shadow-sm transition-colors"
                >
                  <X className="w-4 h-4" />
                </button>
                ...
                <div className="flex items-center gap-4">
                  <div className="relative group">
                    <button
                      ...
                      className="w-16 h-16 rounded-full bg-indigo-600 flex items-center justify-center overflow-hidden ring-4 ring-white dark:ring-slate-900 shadow-sm relative hover:opacity-95 transition-opacity"
                    >
                      {user?.avatar ? (
                    ...
                    <button
                      onClick={() => setIsAvatarModalOpen(true)}
                      className="absolute -bottom-0.5 -right-0.5 w-6 h-6 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-800 rounded-full flex items-center justify-center shadow-sm hover:scale-105 transition-transform"
                    >
                ...
                <div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 p-3.5 shadow-md">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="text-xs font-bold text-slate-700 dark:text-slate-200">Storage</span>
                    </div>
              ...
              <div className="flex-1 p-5 pt-3 overflow-y-auto space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <div className="p-3 rounded-lg bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 flex items-center gap-2.5">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between p-2.5 rounded-lg bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-semibold text-slate-600 text-slate-600 dark:text-slate-400">Member since</span>
                      </div>
                    ...
                    <div className="flex items-center justify-between p-2.5 rounded-lg bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-semibold text-slate-600 text-slate-600 dark:text-slate-400">Plan</span>
                      </div>
                      <span className="text-[9px] font-bold text-indigo-600 dark:text-indigo-400 bg-indigo-50 dark:bg-indigo-950/20 px-1.5 py-0.5 rounded">
                        Free Plan
                      </span>
                    </div>
                  </div>
              ...
              <div className="p-4 border-t border-slate-200 dark:border-slate-800 space-y-2 bg-slate-50/50 dark:bg-slate-950/20">
                <button
                  onClick={() => setIsAvatarModalOpen(true)}
                  className="w-full h-9 flex items-center justify-center gap-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-xs font-bold shadow-sm transition-colors"
                >
