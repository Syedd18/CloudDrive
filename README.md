...
The application lives in the `cloud-drive/` workspace folder.

## What it does

CloudDrive gives you one place to manage files, folders, sharing, and metadata-driven search. The interface is designed to feel fast and practical, with features that cover day-to-day storage workflows and a few advanced productivity tools.
...
- Recent, starred, shared, and trash-oriented views
...
CloudDrive is a modern cloud file manager built with Next.js 14, TypeScript, Prisma, NextAuth, and Supabase Storage. It brings together secure file storage, folder organization, AI-assisted discovery, inline editing, public sharing, and a responsive dashboard for desktop and mobile users.

The application lives in the `cloud-drive/` workspace folder.

## Product Overview

CloudDrive is designed to manage files, folders, and sharing from a single interface. The app supports authenticated storage, public access flows, metadata-driven search, and productivity features that make it feel closer to a full workspace than a simple uploader.
...
- Range selection in grid and list views
- ZIP download for selected files
- Search that spans file names, summaries, and tags
- Quick actions from file cards, list items, and the details panel
